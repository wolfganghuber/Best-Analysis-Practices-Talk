...
You've seen examples for data transformations that compress or stretch the space of quantitative measurements in such a way that the measurements' noise variance  (**not:** the signal variance) is more similar throughout -- i.e., no longer highly dependent on the mean value.
