...
Sometimes we do not know all relevant parameters in an experiment but can 

- try to estimate from the data, or 
- only consider endpoints where the nuisance parameter cancels out  
